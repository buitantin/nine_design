...
<head>
   ...
   <link href="<?php echo e(asset('/public/admin/css/style_purple.css')); ?>" rel="stylesheet" id="style_color" />
...
<body class="fixed-top">
  ...
  <div id="login">
    <!-- BEGIN LOGIN FORM -->
    <?php echo Form::open(['class'=>'form-vertical no-padding no-margin','method'=>'post']); ?>
      ...
      <div class="control-wrap">
          ...
          <div class="control-group">
              <div class="controls">
                  <div class="input-prepend">
                      <?php echo Form::text("username",@$data['username'],array("placeholder"=>"Tên đăng nhập") ); ?>
          ...
          <div class="control-group">
              <div class="controls">
                  <div class="input-prepend">
                      <?php echo Form::password("password",array("placeholder"=>"Mật khẩu" ) ); ?>
