                        ...
                        <div class="widget-body">
                            ...
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                ...
                                <div class="control-group ">
                                  ...
                                  <div class="controls">
                                     <label class="radio">
                                     <input type="radio" name="is_home" value="0" <?php if($data['is_home']==0): ?> checked  <?php endif; ?>/>
                                      Có
                                     </label>
                                     <label class="radio">
                                     <input type="radio" name="is_home" value="1"   <?php if($data['is_home']==1): ?> checked  <?php endif; ?> />
                                      Không
                                     </label>  
                                         ...
                                         <span class="help-inline" style='color:red'>* <?php if(!empty($error['images'])): ?> <?php echo e($error['images']); ?> <?php endif; ?> </span>
                                          <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="<?php echo e(BLOG_URL); ?>small/blog_<?php echo e($data['id']); ?>.jpg" alt="">
                                            </div>
                                            <div>
