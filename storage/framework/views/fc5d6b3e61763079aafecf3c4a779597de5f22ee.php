 ...
 <ul class="sidebar-menu">
              <li class="has-sub <?php if(Request::segments()[1]=='general'): ?> active <?php endif; ?>">
               ...
               <li class="has-sub <?php if(Request::segments()[1]=='cate'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
              ...
              <li class="has-sub <?php if(Request::segments()[1]=='catechild'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
                  ...
                  <ul class="sub">
                      ...
                      <?php foreach($cate as $c): ?>
                          <li><a class="" href="/admin/catechild/cate/<?php echo e($c->id); ?>"><?php echo e($c->name); ?></a></li>
                      <?php endforeach; ?>
              ...
              <li class="has-sub <?php if(Request::segments()[1]=='product' ): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
                  ...
                  <ul class="sub">
                      ...
                      <?php foreach($cate as $c): ?>
                          <li><a class="" href="/admin/product/cate/<?php echo e($c->id); ?>"><?php echo e($c->name); ?></a>
               ...
               <li class="has-sub <?php if(Request::segments()[1]=='order'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
            ...
            <li class="has-sub <?php if(Request::segments()[1]=='blog'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
               ...
               <li class="has-sub <?php if(Request::segments()[1]=='banner' ): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
              ...
              <li class="has-sub <?php if(Request::segments()[1]=='contact'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
              ...
              <li class="has-sub <?php if(Request::segments()[1]=='slideshow'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
              ...
              <li class="has-sub <?php if(Request::segments()[1]=='page'): ?> active <?php endif; ?>">
                  <a href="javascript:;" class="">
