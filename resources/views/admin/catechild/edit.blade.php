                             ...
                             <label class="control-label">Nội bật:</label>  
                               <div class="controls">
                                 ...
                                 <div class="radio" id="uniform-undefined"><span class="">
                                  ...
                                  <input type="radio" name="is_hot" value="0" style="opacity: 0;"  @if($data['is_hot']=='0') checked="" @endif >
                                 ...
                                 <div class="radio" id="uniform-undefined"><span class="checked">
                                    ...
                                    <input type="radio" name="is_hot" value="1" @if($data['is_hot']=='1') checked="" @endif  style="opacity: 0;">
                                    ...
                                    <div class="controls">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                   ...
                                                   <img src="{{CATECHILD_URL.'icon/icon_'.$data['id'].'.png'}}?version=1" alt="">
                                    ...
                                    <div class="controls">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                 ...
                                                 <img src="{{CATECHILD_URL.'cate_'.$data['id'].'.png'}}?version=1" alt="">
